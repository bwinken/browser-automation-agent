...
SKILLS = [
    ...
    },
    {
        ...
        "steps": [
            ...
            "  1-week forecast: cwa.gov.tw/V8/C/W/week.html — full table of all counties.",
            "  Current weather: cwa.gov.tw/V8/C/W/observe/24.html",
            "Data is in well-structured HTML tables — use evaluate_javascript to extract rows.",
            "Weather icons are images, not text — use take_screenshot for visual weather info.",
